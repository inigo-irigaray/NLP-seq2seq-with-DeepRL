...
<p align=justify>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sequential processing of sentences has yield some possitive results, however it sometimes fails to capture the compositionality aspect of languages. Longer sentences can underperform in previous models, especially in tasks like sentiment analysis, because they do not take into account that words group into phrases before reaching the higher sentence structure of language.</p>
